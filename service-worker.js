const CACHE='debt-manager-shell-v8-recovery';
const ASSETS=['./','./index.html','./app-1.b64','./app-2.b64','./app-3.b64','./app-4.b64','./manifest.webmanifest','./icon.svg','./start.html','./diagnose.html'];
